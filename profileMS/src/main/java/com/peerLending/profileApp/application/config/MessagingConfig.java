package com.peerLending.profileApp.application.config;
...
import com.peerLending.profileApp.domain.event.UserRegisteredEventHandler;
...
public class MessagingConfig {
	...
	@Bean
	public MessageListenerAdapter userRegisteredEventLisener(UserRegisteredEventHandler userRegisteredEventHandler) {
