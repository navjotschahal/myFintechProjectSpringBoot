...
public class LoanController {
	...
	@Autowired
	public LoanController(LoanRequestRepository loanRequestRepository, UserRepository userRepository, LoanRequestServiceImpl loanRequestServiceImpl, LoanServiceImpl loanServiceImpl, LoanRepository loanRepository, TokenValidationServiceImpl tokenValidationServiceImpl) {
		super();
	...
	private LoanRequest requestLoan(@RequestBody final LoanRequestDto loanRequestDto, HttpServletRequest request) {
		User borrower = tokenValidationServiceImpl.validateTokenAndGetUser(request.getHeader(HttpHeaders.AUTHORIZATION));
